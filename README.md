...
این برنامه یه ترکیب از ایده تغییر sni پروتوکل reality و ایده های شخصی هست ؛ که اگر وقت پیدا کنم قراره اپدیت هایی مثل  load-balancing,connection multiplexing هم بهش اضافه کنم

این برنامه دربرابر active detection فایر وال مقاوم شده و تست شده است.  

لطفا کامل بخونید توضیحات را.
